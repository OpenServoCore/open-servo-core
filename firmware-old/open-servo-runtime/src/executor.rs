...
use open_servo_shadow::ShadowKernel;
use open_servo_units::{MicroSecond, TimeStampUs};

use crate::runtime::SHADOW_TABLE_SIZE;
...
#[cfg(test)]
pub fn run_medium_commit_for_test<K, PW, const N: usize>(
    kernel: &mut K,
    shadow: &ShadowStorage<N, PW>,
) where
    K: ShadowKernel,
    PW: PersistW,
{

...
pub const VENDOR_FIELDS: &[RegSpec] = &[
    ...
    RegSpec::new("goal_pos_cdeg", addr::GOAL_POS_CDEG, Encoding::I32Le, Access::Rw),
    RegSpec::new("present_pos_cdeg", addr::PRESENT_POS_CDEG, Encoding::I32Le, Access::R),
    RegSpec::new("goal_vel_dps10", addr::GOAL_VEL_DPS10, Encoding::I32Le, Access::Rw),
    RegSpec::new("present_temp_centic", addr::PRESENT_TEMP_CENTIC, Encoding::I16Le, Access::R),
    RegSpec::new("present_voltage_mv", addr::PRESENT_VOLTAGE_MV, Encoding::U16Le, Access::R),
    RegSpec::new("present_current_ma", addr::PRESENT_CURRENT_MA, Encoding::I16Le, Access::R),
    RegSpec::new("pos_min_limit_cdeg", addr::POS_MIN_LIMIT_CDEG, Encoding::I32Le, Access::Rw),
    RegSpec::new("pos_max_limit_cdeg", addr::POS_MAX_LIMIT_CDEG, Encoding::I32Le, Access::Rw),
    RegSpec::new("control_flags", addr::CONTROL_FLAGS, Encoding::U16Le, Access::R),

    // Compliance Control
    RegSpec::new("compliance_mode", addr::COMPLIANCE_MODE, Encoding::U8, Access::R),
    RegSpec::new("compliance_limited", addr::COMPLIANCE_LIMITED, Encoding::U8, Access::R),
    RegSpec::new("move_current_limit", addr::MOVE_CURRENT_LIMIT, Encoding::U16Le, Access::Rw),
    RegSpec::new("hold_current_limit", addr::HOLD_CURRENT_LIMIT, Encoding::U16Le, Access::Rw),
    RegSpec::new("compliance_hysteresis", addr::COMPLIANCE_HYSTERESIS, Encoding::U16Le, Access::Rw),
    RegSpec::new("compliance_deglitch", addr::COMPLIANCE_DEGLITCH, Encoding::U8, Access::Rw),
    RegSpec::new("backoff_factor", addr::BACKOFF_FACTOR, Encoding::U16Le, Access::Rw),
    RegSpec::new("recovery_rate", addr::RECOVERY_RATE, Encoding::U16Le, Access::Rw),
    RegSpec::new("hold_enter_error", addr::HOLD_ENTER_ERROR, Encoding::U16Le, Access::Rw),
    RegSpec::new("hold_exit_error", addr::HOLD_EXIT_ERROR, Encoding::U16Le, Access::Rw),
    RegSpec::new("hold_enter_velocity", addr::HOLD_ENTER_VELOCITY, Encoding::U16Le, Access::Rw),
    RegSpec::new("hold_exit_velocity", addr::HOLD_EXIT_VELOCITY, Encoding::U16Le, Access::Rw),
    RegSpec::new("backdrive_velocity", addr::BACKDRIVE_VELOCITY, Encoding::U16Le, Access::Rw),

    // Debug/Telemetry
    RegSpec::new("control_loop_counter", addr::CONTROL_LOOP_COUNTER, Encoding::U32Le, Access::R),
    RegSpec::new("control_output", addr::CONTROL_OUTPUT, Encoding::I16Le, Access::R),
    RegSpec::new("integral_term", addr::INTEGRAL_TERM, Encoding::I16Le, Access::R),
    RegSpec::new("derivative_term", addr::DERIVATIVE_TERM, Encoding::I16Le, Access::R),
    ...
    RegSpec::new("fault_history", addr::FAULT_HISTORY, Encoding::U32Le, Access::R),

    // Kernel-specific extensions
    RegSpec::new("torque_enable", addr::TORQUE_ENABLE, Encoding::Bool, Access::Rw),
    RegSpec::new("operating_mode", addr::OPERATING_MODE, Encoding::Enum(MODE_NAMES), Access::Rw),
    RegSpec::new("goal_pwm", addr::GOAL_PWM, Encoding::I16Le, Access::Rw),
    RegSpec::new("engaged_mirror", addr::ENGAGED_MIRROR, Encoding::Bool, Access::R),
    RegSpec::new("mode_mirror", addr::MODE_MIRROR, Encoding::Enum(MODE_NAMES), Access::R),
